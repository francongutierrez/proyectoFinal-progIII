    ...
    <section>
        <form action="">
            <div class="container" id="mainContainer">
                ...
                <div class="row">
                    <div class="mt-3">
                        <p>Usted ya tiene una o más postulaciones a un alquiler actualmente. Solo usuarios verificados pueden tener más de una postulación vigente<p>
                        <p id="descripcionError">Que desea hacer?<p>
                    </div>
                </div>
                <div class="row">
