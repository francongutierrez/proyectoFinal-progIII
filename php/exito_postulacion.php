...
<head>
    ...
    <title>RappiBnB - Postulación exitosa</title>
    ...
    <section>
        <form action="">
            <div class="container" id="mainContainer">
                ...
                <div class="row">
                    <div class="mt-3">
                        <p>Se ha postulado su oferta. Debera esperar ahora la respuesta del dueño de la propiedad. En caso de que no se responda su oferta en 72 horas, esta será automaticamente rechazada.<p>
                    </div>
                </div>
                <div class="row">
