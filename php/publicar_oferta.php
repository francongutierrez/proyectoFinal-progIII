    ...
    <section>
        <div class="container" id="mainContainer">
            ...
            <div class="row">
                ...
                <form action="" id="formularioPublicar" class="needs-validation" novalidate onsubmit="return validarForm()" method="POST">
                    <div class="row">
                        <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descripcionInput" rows="3" placeholder="Ingrese la descripcion del alquiler aqui" required></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="cupoInput" placeholder="Ingrese el maximo de personas" min="1" max="10" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mt-3">
