...
<head>
    ...
    <title>RappiBnB - Publicación aceptada</title>
        ...
        <form action="">
            <div class="container" id="mainContainer">
                ...
                <div class="row">
                    ...
                    <a href="../php/publicaciones_pendientes.php" class="btn btn-success" id="botonVolver">Volver a publicaciones pendientes</a>
                    </div>
                </div>
            </div>
        </form>
