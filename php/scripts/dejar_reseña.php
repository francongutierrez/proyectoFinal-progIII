...
$sql_usuario_alquilado = "SELECT id FROM alquileres WHERE id_usuario = ? AND id_propiedad = ? AND estado = ?";
...
if ($result_usuario_alquilado->num_rows == 1 && $result_resena_hecha->num_rows == 0) {
    ...
    <div class="row">
        <div class="col">
            ...
            <form method="POST" id="formResena" onsubmit="validarForm()">
                <textarea name="resena-usuario" class="form-control mt-3" placeholder="Escribe tu reseña aquí" id="descripcionResena"></textarea>
