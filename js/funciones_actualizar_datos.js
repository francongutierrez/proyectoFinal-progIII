...
function validarForm() {
  ...
  const telefonoNumero = parseInt(document.getElementById('telefonoInput').value);
  ...
  if (ciudad != "" && (ciudad.length < 4 || ciudad.length > 100)) {
  ...
  if (telefono != "" && (telefonoNumero < 999999999 || telefonoNumero > 99999999999)) {
  ...
  if (contrasena != "" && (contrasena.length < 8 || contrasena.length > 50)) {
